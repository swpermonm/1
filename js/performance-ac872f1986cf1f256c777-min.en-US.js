(function(n) {
    ...
    "./common/temp/node_modules/@sqs/rum-collector/lib/index.js": function(e, t, n) {
        ...
        function w(e, t, n) {
            ...
            function c(e) {
                e.value instanceof j ? Promise.resolve(e.value.v).then(u, l) : d(a[0][2], e)
            }
        ...
        var de = 3e4;
        var fe = 5e4;
        var me = /(iPhone|iPod|iPad) OS ((1[0-2])|[2-9])_\d+.*AppleWebKit(?!.*Safari)/i;
        ...
        function je() {
            return "function" === typeof window.navigator.sendBeacon && !me.test(window.navigator.userAgent)
        }
            ...
            try {
                if (Ge.length) {
                    ...
                    while (Ge.length) {
                        ...
                        if (!(r.length <= fe && n)) throw new Error("Omitting individual metric because it's over the PER_METRIC_DELIVERY_SIZE (metric is " + r.length + " bytes, delivered from " + window.location.href + ")");
                        e.push(n)
                    }
                    if (e.length) {
        ...
        var st = function(n) {
            ...
            e.prototype.gather = function(e) {
                ...
                if (-1 !== W.indexOf(e.type) && false === this.metricsCollected.interaction) {
            ...
            e.prototype.parse = function(n) {
                var t = this;
                this.deliveryBuffer.length && H.reduce(function(e, t) {
                    t in n && (e[t] = n[t]);
                    return e
        ...
        var ct = st;
        var ut = n("./common/temp/node_modules/resourcetiming-compression/src/resourcetiming-compression.js");
        var lt = n.n(ut);
        var dt = function(t) {
            a(e, t);
            ...
            e.prototype.gather = function(e) {
                if (e.type === $) {
                    var t = e.detail.imageData,
                        n = void 0 === t ? {} : t;
                    this.dataBuffer.info.img = p(p({}, this.dataBuffer.info.img), this.gatherImageInfo(n));
                    return this.dataBuffer
                }
                e.type === ee && (this.readyToDeliver = true);
                this.resourceTimingData = _(this.resourceTimingData, this.gatherImageTimingData());
                return this.dataBuffer
            };
            ...
            e.prototype.initImageLoaderData = function() {
                ...
                if (window.ImageLoader && window.ImageLoader.imageInfo && Object.keys(window.ImageLoader.imageInfo).length) {
                    ...
                    Object.keys(n).forEach(function(e) {
                        t.dataBuffer.info.img = p(p({}, t.dataBuffer.info.img), t.gatherImageInfo(n[e], true))
                    })
                }
            };
            ...
            e.prototype.gatherImageInfo = function(e, t) {
                ...
                var r = e.naturalDimensions,
                    ...
                    u = e.assetUrl,
                    l = e.squarespaceSize,
                    d = v(e, ["naturalDimensions", "parentElementDimensions", "isVisible", "assetUrl", "squarespaceSize"]);
                if (!u || !l) return {};
        ...
        function St(n, r) {
            ...
            var o = function(e) {
                e.forEach(function(e) {
                    var t = new CustomEvent(Tt(e.entryType), {
                        detail: e.toJSON()
                    });
        ...
        function It(e, t, n) {
            ...
            if (window.requestIdleCallback && !n) {
                Pt.push(e);
                xt = xt || window.requestIdleCallback(function(e) {
                    return At(e, t)
                }, {
                    timeout: Ct
                })
        ...
        function At(e, t) {
            try {
                ...
                xt = Pt.length ? window.requestIdleCallback(function(e) {
                    return At(e, t)
                }, {
                    timeout: Ct
                }) : void 0
        ...
        function Mt(r, o) {
            function e(e) {
                ...
                try {
                    t = r.gather(e);
                    if ("pointerdown" === t.eventType) Rt(t, function(e) {
                        return Bt(r, e, o)
                    }, o);
                    else {
        ...
        var Ht = function() {
            return l(void 0, void 0, void 0, function() {
                ...
                return d(this, function(e) {
                    switch (e.label) {
                        case 0:
                            return [4, Promise.all([Ce("domainLookupEnd"), Ce("domainLookupStart")])];
                        case 1:
        ...
        var Yt, Xt, Gt = function() {
            ...
            Zt = function() {
                addEventListener("pagehide", $t), addEventListener("beforeunload", function() {})
            },
            en = function(n) {
                var e = arguments.length > 1 && void 0 !== arguments[1] && arguments[1];
                Qt || (Zt(), Qt = !0), addEventListener("visibilitychange", function(e) {
                    var t = e.timeStamp;
            ...
            rn = function() {
                return void 0 === Yt && (Yt = "hidden" === document.visibilityState ? 0 : 1 / 0, en(function(e) {
                    var t = e.timeStamp;
                    return Yt = t
                }, !0)), {
                    get timeStamp() {
            ...
            sn = function() {
                return Xt = Xt || new Promise(function(t) {
        ...
        var On = function() {
            return l(void 0, void 0, void 0, function() {
                ...
                return d(this, function(e) {
                    switch (e.label) {
                        case 0:
                            return [4, Promise.all([Ce("connectEnd"), Ce("secureConnectionStart")])];
                        case 1:
                            t = e.sent(), n = t[0], r = t[1];
                            if (!(n && r)) return [2, null];
                            o = n - r;
    ...
    "./common/temp/node_modules/@sqs/track-events/v2.js": function(e, t, n) {
        e.exports = function(n) {
            ...
            e.exports = function(n) {
                ...
                function m() {
                    ...
                    try {
                        ...
                        n && (r ? sessionStorage.setItem(c, "true") : sessionStorage.setItem(c, "false"));
                        if (!o) {
                            o = (0, i.default)();
                            f(l, o)
                        }
            ...
            e.exports = n("./common/temp/node_modules/core-js/modules/es.promise.js")
        }, function(e, t, n) {
            "use strict";
            ...
            e.exports = function(e, t, n, r) {
                ...
                for (var c = 0; c < s; ++c) {
                    ...
                    v(o, m) ? h(o[m]) ? o[m].push(p) : o[m] = [o[m], p] : o[m] = p
                }
                return o
            };
            ...
            e.exports = function(n, r, o, e) {
                ...
                o = o || "=";
                null === n && (n = void 0);
                if ("object" === typeof n) return s(c(n), function(e) {
                    ...
                    value: function e(t) {
                        ...
                        try {
                            ...
                            if (c) {
                                ...
                                g.a.set(this._config.storageKey, null, {
                                    expires: u
                                })
                            }
            ...
            function A(e, t) {
                A = Object.setPrototypeOf || function e(t, n) {
                    t.__proto__ = n;
                    return t
                };
                return A(e, t)
                ...
                C(i, [{
                    ...
                    value: function e(t) {
                        ...
                        var i = o.context_website_id,
                            ...
                            m = w(o, ["context_website_id", "custom_schema_name", "destination_url", "member_account_id", "object_identifier", "resolved_locale", "website_locale", "member_account_locale"]);
                        var p = {
    ...
    "./common/temp/node_modules/core-js/internals/a-function.js": function(e, t) {
        e.exports = function(e) {
            if ("function" != typeof e) throw TypeError(String(e) + " is not a function");
            return e
        }
    },
    "./common/temp/node_modules/core-js/internals/an-instance.js": function(e, t) {
    ...
    "./common/temp/node_modules/core-js/internals/array-includes.js": function(e, t, n) {
        ...
        var l = n("./common/temp/node_modules/core-js/internals/to-absolute-index.js");
        var r = function(s) {
    ...
    "./common/temp/node_modules/core-js/internals/check-correctness-of-iteration.js": function(e, t, n) {
        var r = n("./common/temp/node_modules/core-js/internals/well-known-symbol.js");
        var o = r("iterator");
        var i = false;
        try {
            var a = 0;
    ...
    "./common/temp/node_modules/core-js/internals/classof.js": function(e, t, n) {
        var r = n("./common/temp/node_modules/core-js/internals/to-string-tag-support.js");
        var o = n("./common/temp/node_modules/core-js/internals/classof-raw.js");
        var i = n("./common/temp/node_modules/core-js/internals/well-known-symbol.js");
        var a = i("toStringTag");
        var s = "Arguments" == o(function() {
            return arguments
        }());
        var c = function(e, t) {
            try {
    ...
    "./common/temp/node_modules/core-js/internals/copy-constructor-properties.js": function(e, t, n) {
        ...
        var u = n("./common/temp/node_modules/core-js/internals/object-get-own-property-descriptor.js");
        var l = n("./common/temp/node_modules/core-js/internals/object-define-property.js");
        e.exports = function(e, t) {
            var n = c(t);
            var r = l.f;
            var o = u.f;
    ...
    "./common/temp/node_modules/core-js/internals/create-non-enumerable-property.js": function(e, t, n) {
        ...
        var o = n("./common/temp/node_modules/core-js/internals/object-define-property.js");
        var i = n("./common/temp/node_modules/core-js/internals/create-property-descriptor.js");
    ...
    "./common/temp/node_modules/core-js/internals/create-property-descriptor.js": function(e, t) {
        e.exports = function(e, t) {
            return {
                enumerable: !(1 & e),
                configurable: !(2 & e),
    ...
    "./common/temp/node_modules/core-js/internals/engine-is-ios.js": function(e, t, n) {
        var r = n("./common/temp/node_modules/core-js/internals/engine-user-agent.js");
    ...
    "./common/temp/node_modules/core-js/internals/enum-bug-keys.js": function(e, t) {
    ...
    "./common/temp/node_modules/core-js/internals/export.js": function(e, t, n) {
        ...
        var f = n("./common/temp/node_modules/core-js/internals/object-get-own-property-descriptor.js").f;
        var m = n("./common/temp/node_modules/core-js/internals/create-non-enumerable-property.js");
        ...
        var h = n("./common/temp/node_modules/core-js/internals/copy-constructor-properties.js");
    ...
    "./common/temp/node_modules/core-js/internals/hidden-keys.js": function(e, t) {
        e.exports = {}
    },
    ...
    "./common/temp/node_modules/core-js/internals/ie8-dom-define.js": function(e, t, n) {
        ...
        var i = n("./common/temp/node_modules/core-js/internals/document-create-element.js");
    ...
    "./common/temp/node_modules/core-js/internals/internal-state.js": function(e, t, n) {
        var r = n("./common/temp/node_modules/core-js/internals/native-weak-map.js");
        var o = n("./common/temp/node_modules/core-js/internals/global.js");
        var i = n("./common/temp/node_modules/core-js/internals/is-object.js");
        var a = n("./common/temp/node_modules/core-js/internals/create-non-enumerable-property.js");
        var s = n("./common/temp/node_modules/core-js/internals/has.js");
        ...
        var v = function(n) {
            return function(e) {
                var t;
                if (!i(e) || (t = f(e)).type !== n) throw TypeError("Incompatible receiver, " + n + " required");
                return t
            }
        };
        if (r) {
    ...
    "./common/temp/node_modules/core-js/internals/iterate.js": function(e, t, n) {
        ...
        var p = n("./common/temp/node_modules/core-js/internals/is-array-iterator-method.js");
        ...
        var g = n("./common/temp/node_modules/core-js/internals/get-iterator-method.js");
        var y = n("./common/temp/node_modules/core-js/internals/call-with-safe-iteration-closing.js");
        var _ = function(e, t) {
            this.stopped = e;
            this.result = t
        };
    ...
    "./common/temp/node_modules/core-js/internals/microtask.js": function(e, t, n) {
        var r = n("./common/temp/node_modules/core-js/internals/global.js");
        var o = n("./common/temp/node_modules/core-js/internals/object-get-own-property-descriptor.js").f;
    ...
    "./common/temp/node_modules/core-js/internals/object-define-property.js": function(e, t, n) {
        var r = n("./common/temp/node_modules/core-js/internals/descriptors.js");
        var o = n("./common/temp/node_modules/core-js/internals/ie8-dom-define.js");
        var i = n("./common/temp/node_modules/core-js/internals/an-object.js");
    ...
    "./common/temp/node_modules/core-js/internals/object-get-own-property-descriptor.js": function(e, t, n) {
        var r = n("./common/temp/node_modules/core-js/internals/descriptors.js");
        var o = n("./common/temp/node_modules/core-js/internals/object-property-is-enumerable.js");
        var i = n("./common/temp/node_modules/core-js/internals/create-property-descriptor.js");
        var a = n("./common/temp/node_modules/core-js/internals/to-indexed-object.js");
        ...
        var u = n("./common/temp/node_modules/core-js/internals/ie8-dom-define.js");
    ...
    "./common/temp/node_modules/core-js/internals/object-get-own-property-names.js": function(e, t, n) {
        var r = n("./common/temp/node_modules/core-js/internals/object-keys-internal.js");
        var o = n("./common/temp/node_modules/core-js/internals/enum-bug-keys.js");
        var i = o.concat("length", "prototype");
        t.f = Object.getOwnPropertyNames || function e(t) {
            return r(t, i)
        }
    },
    "./common/temp/node_modules/core-js/internals/object-get-own-property-symbols.js": function(e, t) {
    ...
    "./common/temp/node_modules/core-js/internals/object-keys-internal.js": function(e, t, n) {
        ...
        var s = n("./common/temp/node_modules/core-js/internals/to-indexed-object.js");
        var c = n("./common/temp/node_modules/core-js/internals/array-includes.js").indexOf;
        var u = n("./common/temp/node_modules/core-js/internals/hidden-keys.js");
        e.exports = function(e, t) {
            var n = s(e);
            var r = 0;
    ...
    "./common/temp/node_modules/core-js/internals/own-keys.js": function(e, t, n) {
        var r = n("./common/temp/node_modules/core-js/internals/get-built-in.js");
        var o = n("./common/temp/node_modules/core-js/internals/object-get-own-property-names.js");
        var i = n("./common/temp/node_modules/core-js/internals/object-get-own-property-symbols.js");
    ...
    "./common/temp/node_modules/core-js/internals/promise-resolve.js": function(e, t, n) {
        ...
        var i = n("./common/temp/node_modules/core-js/internals/is-object.js");
        var a = n("./common/temp/node_modules/core-js/internals/new-promise-capability.js");
        e.exports = function(e, t) {
            o(e);
    ...
    "./common/temp/node_modules/core-js/internals/redefine.js": function(e, t, n) {
        ...
        var c = n("./common/temp/node_modules/core-js/internals/create-non-enumerable-property.js");
    ...
    "./common/temp/node_modules/core-js/internals/require-object-coercible.js": function(e, t) {
        e.exports = function(e) {
    ...
    "./common/temp/node_modules/core-js/internals/set-global.js": function(e, t, n) {
        var r = n("./common/temp/node_modules/core-js/internals/global.js");
        var o = n("./common/temp/node_modules/core-js/internals/create-non-enumerable-property.js");
    ...
    "./common/temp/node_modules/core-js/internals/set-to-string-tag.js": function(e, t, n) {
        var r = n("./common/temp/node_modules/core-js/internals/object-define-property.js").f;
    ...
    "./common/temp/node_modules/core-js/internals/task.js": function(e, t, n) {
        ...
        var o = n("./common/temp/node_modules/core-js/internals/fails.js");
        var i = n("./common/temp/node_modules/core-js/internals/classof-raw.js");
        var a = n("./common/temp/node_modules/core-js/internals/function-bind-context.js");
        var s = n("./common/temp/node_modules/core-js/internals/html.js");
        var c = n("./common/temp/node_modules/core-js/internals/document-create-element.js");
        ...
        if (!d || !f) {
            ...
            if ("process" == i(m)) _ = function(e) {
                m.nextTick(E(e))
            };
            else if (v && v.now) _ = function(e) {
                v.now(E(e))
            };
            else if (p && !u) {
                j = new p;
            ...
            } else if (!r.addEventListener || "function" != typeof postMessage || r.importScripts || o(T) || "file:" === l.protocol) _ = y in c("script") ? function(e) {
    ...
    "./common/temp/node_modules/core-js/internals/to-indexed-object.js": function(e, t, n) {
        var r = n("./common/temp/node_modules/core-js/internals/indexed-object.js");
    ...
    "./common/temp/node_modules/core-js/internals/use-symbol-as-uid.js": function(e, t, n) {
        var r = n("./common/temp/node_modules/core-js/internals/native-symbol.js");
    ...
    "./common/temp/node_modules/core-js/internals/well-known-symbol.js": function(e, t, n) {
        ...
        var s = n("./common/temp/node_modules/core-js/internals/native-symbol.js");
        var c = n("./common/temp/node_modules/core-js/internals/use-symbol-as-uid.js");
        var u = o("wks");
        var l = r.Symbol;
    ...
    "./common/temp/node_modules/core-js/modules/es.promise.js": function(e, t, n) {
        ...
        var s = n("./common/temp/node_modules/core-js/internals/native-promise-constructor.js");
        ...
        var l = n("./common/temp/node_modules/core-js/internals/set-to-string-tag.js");
        ...
        var y = n("./common/temp/node_modules/core-js/internals/check-correctness-of-iteration.js");
        var _ = n("./common/temp/node_modules/core-js/internals/species-constructor.js");
        ...
        var b = n("./common/temp/node_modules/core-js/internals/promise-resolve.js");
        var E = n("./common/temp/node_modules/core-js/internals/host-report-errors.js");
        var S = n("./common/temp/node_modules/core-js/internals/new-promise-capability.js");
        ...
        var x = n("./common/temp/node_modules/core-js/internals/well-known-symbol.js");
        var C = n("./common/temp/node_modules/core-js/internals/engine-v8-version.js");
        var I = x("species");
        var A = "Promise";
        var k = O.get;
        var R = O.set;
                ...
                while (p.length > n) {
                    ...
                    try {
                        if (o) {
                            ...
                            c === r.promise ? a(N("Promise-chain cycle")) : (u = re(c)) ? u.call(c, i, a) : i(c)
                        } else a(e)
                    } catch (e) {
                        s && !l && s.exit();
                        a(e)
        ...
        if (te) {
            ...
            if (!o && "function" == typeof s) {
                ee = s.prototype.then;
                c(s.prototype, "then", function e(t, n) {
                    var r = this;
    ...
    "./common/temp/node_modules/resourcetiming-compression/src/resourcetiming-compression.js": function(n, r, e) {
        var o, i;
        (function(p) {
            "use strict";
            var e;
            ...
            g.convertToTrie = function(e) {
                ...
                for (n in e) {
                    ...
                    r = n;
                    for (o = 0; o < this.xssBreakWords.length; o++) r = r.replace(this.xssBreakWords[o], "$1" + g.XSS_BREAK_DELIM + "$2");
                    i = e[n];
                    a = r.split("");
                    c = t;
                    for (o = 0; o < a.length; o++) {
                        s = a[o];
                        u = c[s];
                        "undefined" === typeof u ? c = c[s] = o === a.length - 1 ? i : {} : "string" === typeof u ? c = c[s] = {
                            "|": u
                        } : o === a.length - 1 ? c[s]["|"] = i : c = c[s]
                    }
                }
                return t
            };
                ...
                try {
                    ...
                    if (e.frames)
                        for (i = 0; i < e.frames.length; i++) {
                            ...
                            u = 0;
                            c > s && (u = n + (c - s));
                            o = o.concat(this.findPerformanceEntriesForFrame(e.frames[i], false, u, ++r))
                        }
                    try {
                    ...
                    if (t) {
                        ...
                        if (a && 1 === a.length) {
                            ...
                            0 !== d.navigationStart && d.responseEnd <= d.navigationStart + 36e5 && o.push({
                                name: e.location.href,
                                startTime: 0,
                                initiatorType: "html",
                    ...
                    for (i = 0; g && i < g.length; i++) {
                        ...
                        m = {
                            ...
                            domainLookupStart: d.domainLookupStart ? d.domainLookupStart + n : 0,
                            domainLookupEnd: d.domainLookupEnd ? d.domainLookupEnd + n : 0,
                            connectStart: d.connectStart ? d.connectStart + n : 0,
                            secureConnectionStart: d.secureConnectionStart ? d.secureConnectionStart + n : 0,
                        ...
                        d.serverTiming && d.serverTiming.length && (m.serverTiming = d.serverTiming);
            ...
            g.updateScriptFlags = function(e, t, n) {
                if (("script" === t.initiatorType || "link" === t.initiatorType) && e[t.name]) {
                    var r = e[t.name];
                    n.scriptAttrs = (r.async ? g.SPECIAL_DATA_SCRIPT_ASYNC_ATTR : 0) | (r.defer ? g.SPECIAL_DATA_SCRIPT_DEFER_ATTR : 0);
                    while (1 === r.nodeType && "BODY" !== r.nodeName) r = r.parentNode;
                    n.scriptAttrs |= "BODY" === r.nodeName ? g.SPECIAL_DATA_SCRIPT_LOCAT_ATTR : 0
                }
            };
            ...
            g.getVisibleEntries = function(e) {
                ...
                var t = ["img", "iframe", "image"],
                    ...
                    l, d, f = e.document,
                    m = f.createElement("A");
                l = void 0 !== e.pageXOffset ? e.pageXOffset : (f.documentElement || f.body.parentNode || f.body).scrollLeft;
                d = void 0 !== e.pageYOffset ? e.pageYOffset : (f.documentElement || f.body.parentNode || f.body).scrollTop;
                t.forEach(function(e) {
                    ...
                    for (r = 0; r < t.length; r++) {
                        ...
                        if ((o.height || n.offsetHeight) && (o.width || n.offsetWidth)) {
                            u[i] = [o.height || n.offsetHeight, o.width || n.offsetWidth, Math.round(o.top + d), Math.round(o.left + l)];
                            ...
                            if (n.currentSrc && (n.srcset || n.parentNode && n.parentNode.nodeName && "PICTURE" === n.parentNode.nodeName.toUpperCase())) {
                                a = n.isConnected ? n.ownerDocument.createElement("IMG") : new p.Image;
                                a.src = i
                            } else a = n;
                            s = a.naturalHeight || n.naturalHeight;
                            c = a.naturalWidth || n.naturalWidth;
                            !s && !c || u[i][0] === s && u[i][1] === c || u[i].push(s, c)
                        }
                    }
                });
                return u
            ...
            g.compressResourceTiming = function(e, t, i, n) {
                ...
                for (r = 0; r < t.length; r++) {
                    ...
                    "" !== f && (l += g.SPECIAL_DATA_PREFIX + g.SPECIAL_DATA_SIZE_TYPE + f);
                    o.hasOwnProperty("scriptAttrs") && (l += g.SPECIAL_DATA_PREFIX + g.SPECIAL_DATA_SCRIPT_TYPE + o.scriptAttrs);
                    o.hasOwnProperty("linkAttrs") && (l += g.SPECIAL_DATA_PREFIX + g.SPECIAL_DATA_LINK_ATTR_TYPE + o.linkAttrs);
                    o.serverTiming && o.serverTiming.length && (l += g.SPECIAL_DATA_PREFIX + g.SPECIAL_DATA_SERVERTIMING_TYPE + o.serverTiming.reduce(function(e, t, n) {
                        var r = String(t.duration);
                        "0." === r.substring(0, 2) && (r = r.substring(1));
                        var o = g.identifyServerTimingEntry(i.indexed[t.name].index, i.indexed[t.name].descriptions[t.description]);
                        e += (n > 0 ? "," : "") + r + o;
                        return e
                    }, ""));
                    if (o.workerStart && "number" === typeof o.workerStart && 0 !== o.workerStart) {
                        ...
                        l += g.SPECIAL_DATA_PREFIX + g.SPECIAL_DATA_SERVICE_WORKER_TYPE + this.toBase36(p)
                    }
                    u = c = this.trimUrl(o.name, this.trimUrls);
                    g.HOSTNAMES_REVERSED && (u = this.reverseHostname(c));
                    if (o.hasOwnProperty("_data")) {
                        var v = "";
                        for (var h in o._data) o._data.hasOwnProperty(h) && (v += g.SPECIAL_DATA_PREFIX + g.SPECIAL_DATA_NAMESPACED_TYPE + h + ":" + o._data[h]);
                        "undefined" === typeof a[c] ? a[c] = l + v : a[c] += v
                    } else void 0 !== a[u] ? a[u] += "|" + l : void 0 !== d[c] ? a[u] = g.SPECIAL_DATA_PREFIX + g.SPECIAL_DATA_DIMENSION_TYPE + d[c].map(this.toBase36).join(",").replace(/,+$/, "") + "|" + l : a[u] = l
                }
                return {
    ...
    "./common/temp/node_modules/tti-polyfill/tti-polyfill.js": function(T, O, e) {
        (function(b) {
            var E, S;
            (function() {
                var t = "undefined" != typeof window && window === this ? this : "undefined" != typeof b && null != b ? b : this,
                ...
                function f(i, a) {
                    ...
                    fetch = function(e) {
                        ...
                        return new Promise(function(t, n) {
                            var r = l++;
                            i(r);
                            s.apply(null, [].concat(u(o))).then(function(e) {
                                a(r);
                                t(e)
                            }, function(e) {
                                a(e);
                ...
                function p(e, t) {
                    ...
                    for (var n = e.next(); !n.done; n = e.next())
                        if (n = n.value, t.includes(n.nodeName.toLowerCase()) || p(n.children, t)) return !0;
                    return !1
                }
                ...
                function v(n) {
                    var e = new MutationObserver(function(e) {
                        e = c(e);
                        for (var t = e.next(); !t.done; t = e.next()) t = t.value, "childList" == t.type && p(t.addedNodes, m) ? n(t) : "attributes" == t.type && m.includes(t.target.tagName.toLowerCase()) && n(t)
                    });
                    e.observe(document, {
                        attributes: !0,
                        childList: !0,
                    ...
                    r.c = new PerformanceObserver(function(e) {
                        ...
                        for (var t = e.next(); !t.done; t = e.next())
                            if (t = t.value, "resource" === t.entryType && (r.b.push({
                                ...
                                }), _(r, h(r.g, r.b) + 5e3)), "longtask" === t.entryType) {
                ...
                true, T.exports ? T.exports = w : (true, !(E = [], S = function() {
                    return w
                }.apply(O, E), void 0 !== S && (T.exports = S)))
            })()
    ...
    "./src/main/webapp/universal/src/apps/Performance/bootstrap.js": function(e, t, n) {
        ...
        var u = n("./src/main/webapp/universal/src/shared/utils/error-reporter/global-sentry.ts");
        ...
        var m = Object.freeze((0, o.default)({}, a.default.COMMERCE_CART_V2, "commerce-cart"));
...
//# sourceMappingURL=https://sourcemaps.squarespace.net/universal/scripts-compressed/performance-928856126a4f1b3aac2b5-min.en-US.js.map